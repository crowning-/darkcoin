...
public:
    ...
    void setInfo(const std::string &strMNPrivKey, const std::string &strMNAlias);

private Q_SLOTS:
    void on_button_copyAlias_clicked();
    void on_button_copyKey_clicked();
    void update();
